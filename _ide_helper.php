 ...
 * Generated for Laravel 6.4.0 on 2019-11-21 15:23:17.
 *
...
namespace Facade\Ignition\Facades {
    ...
    class Flare {
         ...
         * @param null $contextDetector
         * @param null $container
         * @return \Facade\FlareClient\Flare
         */
         ...
         * @static
         * @param $throwable
         * @return \Facade\FlareClient\Report
         */
         ...
         * @param $key
         * @param $value
         * @return \Facade\FlareClient\Concerns\HasContext
         */
