        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('specialty_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.specialties.index") }}" class="nav-link {{ request()->is('admin/specialties') || request()->is('admin/specialties/*') ? 'active' : '' }}">
                            <i class="fa-fw fas fa-cogs">

                            </i>
                            <p>
                                <span>{{ trans('cruds.specialty.title') }}</span>
                            </p>
                        </a>
                    </li>
                @endcan
                @can('pharmacy_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.pharmacies.index") }}" class="nav-link {{ request()->is('admin/pharmacies') || request()->is('admin/pharmacies/*') ? 'active' : '' }}">
                            ...
                            <p>
                                <span>{{ trans('cruds.pharmacy.title') }}</span>
                            </p>
                        </a>
                    </li>
                @endcan
